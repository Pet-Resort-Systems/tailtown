...
const MessageTemplates: React.FC = () => {
  ...
  const filteredTemplates = templates.filter((t) => {
    ...
    if (tabValue === 4)
      return t.category === 'marketing' || t.category === 'promotional';
    return true;
  });
  ...
  return (
    <Container maxWidth="xl">
      <Box sx={{ mt: 4, mb: 4 }}>
        ...
        >
          <Box>
            ...
            <Typography variant="body1" color="text.secondary">
              Create and manage reusable templates for SMS and email
              communications
            </Typography>
          </Box>
          <Button
        ...
        <Alert severity="info" sx={{ mb: 3 }}>
          <Typography variant="body2">
            <strong>Available Variables:</strong> Use double curly braces to
            insert dynamic content. Common variables: customerName, petName,
            appointmentTime, businessName, businessPhone (wrap in double curly
            braces)
          </Typography>
        </Alert>
        ...
        <DialogContent>
          <Box sx={{ pt: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <FormControl fullWidth>
              ...
              >
                <MenuItem value="appointment_reminder">
            ...
            <Alert severity="info">
              <Typography variant="body2">
                <strong>Common Variables (wrap in double curly braces):</strong>
                <br />
                customerName, petName, appointmentTime, appointmentDate,
                serviceName, businessName, businessPhone, businessAddress
              </Typography>
            </Alert>
          </Box>
        </DialogContent>
      ...
      <Dialog
        open={openUseDialog}
        onClose={() => setOpenUseDialog(false)}
        maxWidth="md"
        fullWidth
      >
          ...
          <Box sx={{ pt: 2 }}>
            <Alert severity="info" sx={{ mb: 3 }}>
              ...
              <Typography variant="body2" component="div" sx={{ mt: 1 }}>
                1. Go to <strong>SMS Marketing</strong> or{' '}
                <strong>Email Marketing</strong> to send this template
                <br />
                2. Select recipients from your customer list
                <br />
                3. The template will auto-fill with customer/pet data
                <br />
                4. Review and send!
              </Typography>
            </Alert>
