...
const InvoiceDetailsDialog: React.FC<InvoiceDetailsDialogProps> = ({
  ...
  const renderTableRows = () => {
      ...
      invoice.lineItems.forEach((item, index) => {
        ...
        if (
          ...
          (item.description === 'Service' ||
            item.description === 'Reservation Service')
        ) {
    ...
    rows.push(
      <TableRow key="tax">
        <TableCell colSpan={3} align="right">
          Tax ({(invoice.taxRate ? invoice.taxRate * 100 : 0).toFixed(2)}%)
        </TableCell>
        <TableCell align="right">
              ...
              <Grid
                ...
                <Typography variant="body1">
                  {invoice.reservation.startDate
                    ? format(
                        new Date(invoice.reservation.startDate),
                        'MM/dd/yyyy'
                      )
                    : 'N/A'}
                </Typography>
              ...
              <Grid
                ...
                <Typography variant="body1">
                  {invoice.reservation.endDate
                    ? format(
                        new Date(invoice.reservation.endDate),
                        'MM/dd/yyyy'
                      )
                    : 'N/A'}
                </Typography>
