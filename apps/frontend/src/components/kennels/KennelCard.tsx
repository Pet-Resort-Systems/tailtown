...
const KennelCard: React.FC<KennelCardProps> = React.memo(
  ({
    ...
    const formattedKennelNumber =
      typeof kennelNumber === 'string' && kennelNumber.length > 1
      ...
      <PrintableCard>
        ...
        <CardContent sx={{ p: 0 }}>
              ...
              <Box sx={{ mt: 4, mb: 4 }}>
                ...
                <Box sx={{ pl: 2 }}>
                  <Typography variant="h6" sx={{ mb: 1, fontSize: '1.375rem' }}>
                    ...
                    {formattedKennelNumber}
                  </Typography>
                  <Typography variant="h6" sx={{ mb: 1 }}>
                    <strong>Check-In:</strong> {formattedDates.startDate} at{' '}
                    {formattedDates.startTime}
                  </Typography>
                  <Typography variant="h6" sx={{ mb: 1 }}>
                    <strong>Check-Out:</strong> {formattedDates.endDate} at{' '}
          ...
          <Box sx={{ mt: 4, mb: 4 }}>
            <SectionTitle
              variant="h5"
              sx={{ fontSize: '1.5rem', mb: 2, color: 'primary.dark' }}
            >
              WEEKLY SCHEDULE
            </SectionTitle>
            <TableContainer
