...
describe('TrainingClasses - Validation', () => {
  beforeEach(() => {
    ...
    (mockSchedulingService.trainingClasses.getAll as jest.Mock) = jest
      .fn()
      .mockResolvedValue([]);
  ...
  describe('Required Field Validation', () => {
    it('should show error when name is missing', async () => {
      ...
      // Should not call API
      expect(
        mockSchedulingService.trainingClasses.create
  ...
  describe('Date Formatting', () => {
    it('should convert Date objects to ISO strings before API call', async () => {
      (
        mockSchedulingService.trainingClasses.create as jest.Mock
  ...
  describe('API Error Handling', () => {
    ...
    it('should display generic error message when backend message not available', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/failed to save training class/i)
        ).toBeInTheDocument();
      });
    });
  ...
  describe('Successful Creation', () => {
    it('should call API with all form data when validation passes', async () => {
      (
        mockSchedulingService.trainingClasses.create as jest.Mock
      ).mockResolvedValue({ id: 'class-1', name: 'Puppy Training' });
    ...
    it('should reload class list after successful creation', async () => {
      ...
      const initialCallCount = (
        mockSchedulingService.trainingClasses.getAll as jest.Mock
      ).mock.calls.length;
      ...
      await waitFor(() => {
        expect(
          (mockSchedulingService.trainingClasses.getAll as jest.Mock).mock.calls
            .length
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle negative price gracefully', async () => {
      ...
      await waitFor(() => {
        ...
        const apiCalled =
          (mockSchedulingService.trainingClasses.create as jest.Mock).mock.calls
            .length > 0;
