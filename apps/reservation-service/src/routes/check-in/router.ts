...
router.put('/check-ins/:checkInId/medications/:medicationId', updateCheckInMedicationRoute);
router.delete('/check-ins/:checkInId/medications/:medicationId', deleteCheckInMedicationRoute);
router.put('/check-ins/:checkInId/belongings/:belongingId/return', returnCheckInBelongingRoute);
