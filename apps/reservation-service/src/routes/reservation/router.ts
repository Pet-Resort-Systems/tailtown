...
import { route as getRecentReservationActivityRoute } from './get-recent-reservation-activity.route.js';
import { route as getReservationActivityRoute } from './get-reservation-activity.route.js';
...
router.get('/activity/recent', getRecentReservationActivityRoute);
router.get('/', getAllReservationsRoute);
router.post('/', createReservationRoute);
router.get('/:id/activity', getReservationActivityRoute);
