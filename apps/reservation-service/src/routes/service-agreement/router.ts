...
router.get(
  ...
  getAllServiceAgreementTemplatesRoute
);
router.get(
  '/service-agreement-templates/default',
  getDefaultServiceAgreementTemplateRoute
);
router.get(
  '/service-agreement-templates/:id/versions/:version',
  getServiceAgreementTemplateVersionRoute
);
router.get(
  '/service-agreement-templates/:id/versions',
  getServiceAgreementTemplateVersionsRoute
);
router.get(
  '/service-agreement-templates/:id',
  getServiceAgreementTemplateByIdRoute
);
router.post(
  '/service-agreement-templates',
  createServiceAgreementTemplateRoute
);
router.put(
  '/service-agreement-templates/:id',
  updateServiceAgreementTemplateRoute
);
router.delete(
  '/service-agreement-templates/:id',
  deleteServiceAgreementTemplateRoute
);
router.get(
  '/service-agreements/check-in/:checkInId',
  getServiceAgreementByCheckInIdRoute
);
router.get(
  '/service-agreements/customer/:customerId/valid',
  getValidCustomerServiceAgreementRoute
);
router.get(
  '/service-agreements/customer/:customerId',
  getCustomerServiceAgreementsRoute
);
...
router.put(
  ...
  invalidateServiceAgreementRoute
);
