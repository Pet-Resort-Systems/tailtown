...
export const calculateRefund = async (
  ...
  try {
    const { depositAmount, cancellationDate, checkInDate, refundPolicy } =
      req.body;
...
export const validateDepositPayment = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
// Get deposit rules
export const getDepositRules = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
// Delete deposit rule
export const deleteDepositRule = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
